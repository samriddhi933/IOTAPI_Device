...
public partial class ferrodbContext : DbContext
{
    ...
    public virtual DbSet<DeviceInstallationDetail> DeviceInstallationDetails { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DeviceInstallationDetail>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("device_installation_details");
